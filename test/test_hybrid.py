...
class TestQuantitativeRisk(unittest.TestCase):
    ...
    def test_greater_than(self):
        ...
        risk_mod = HybridRisk(values={'threat_event_frequency': {'min':1,'probable':3,'max':5}, 'vulnerability': {'min':1,'probable':2,'max':3}, 'loss_magnitude':{'min':30,'probable':40,'max':50}, 'budget': 10000, 'currency':"SEK"})
